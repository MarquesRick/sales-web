...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        //Metodo responsavel por popular a base de dados
        public void Seed()
        {
            //Se existir algum dado nas tabelas abaixo
            if(_context.Department.Any() || _context.SalesRecord.Any() || _context.Seller.Any())
            {
                return; //DB has seeded
            }

            //Como estamos usando o Code First se instanciados os objs e depois populados
